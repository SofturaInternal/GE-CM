...
#Convert XLS -> CSV#
####################
logging.info("Converting QueryResult xls file csv")
...
insert_log(msg = "QueryResult xls file is converted to csv")
#logging.shutdown()
...
############################################
       ...
       DEF_DSRVW = data[i]['DEF_DSRVW']
       query = "INSERT INTO  cmdb_design.release(ReleaseID,Product_Descriptors, Product_Descriptor_Level3,  SRP, DEF_DSRVW,DSRVW_Status , Release_Branch_Name, Tollgate_URL, Build_Machine, Jenkinsfile_Commit_No, Software_Tools, Hardware_Platform, Testing_Tools, BoM) VALUES (%s,%s,%s,%s, %s, %s, %s,%s,%s, %s, %s, %s, %s, %s)"
       values = (j,Product_Descriptors, Product_Descriptor_Level3, SRP, DEF_DSRVW, DSRVW_Status , Release_Branch_Name, Tollgate_URL, Build_Machine, Jenkinsfile_Commit_No, Software_Tools, Hardware_Platform, Testing_Tools, BoM)
       print values
       try:
