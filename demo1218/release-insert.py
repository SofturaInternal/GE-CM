...
############################################
       ...
       query = "INSERT INTO  cmdb_design.release(ReleaseID, SRP , Release_Branch_Name, Tollgate_URL, Build_Machine, Jenkinsfile_Commit_No, Software_Tools, Hardware_Platform, Testing_Tools, BoM) VALUES (%s,%s,%s,%s,%s,%s,%s, %s, %s, %s)"
       values = (j, SRP, Release_Branch_Name, Tollgate_URL, Build_Machine, Jenkinsfile_Commit_No, Software_Tools, Hardware_Platform, Testing_Tools, BoM)
       print values
       try:
